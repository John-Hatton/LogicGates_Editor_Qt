...
//};
//
//Editor::Editor(QWidget *parent) : QGraphicsView(parent), scene(new QGraphicsScene(this)), scaleFactor(1.0), isPanning(false), viewCenter(0, 0), currentConnection(nullptr), startPoint(nullptr), hoveredPoint(nullptr), undoStack(new QUndoStack(this)) {
//    // Create the scene and set it
//    setScene(scene);
//    setRenderHint(QPainter::Antialiasing);
//    setDragMode(QGraphicsView::NoDrag);
...
//#include <QApplication>
//
//Editor::Editor(QWidget *parent) : QGraphicsView(parent), scene(new QGraphicsScene(this)), scaleFactor(1.0), isPanning(false), viewCenter(0, 0), currentConnection(nullptr), startPoint(nullptr), hoveredPoint(nullptr), undoStack(new QUndoStack(this)), rubberBand(nullptr) {
//    // Create the scene and set it
//    setScene(scene);
//    setRenderHint(QPainter::Antialiasing);
//    setDragMode(QGraphicsView::NoDrag);
...
//void Editor::createNode() {
//    Node *node = new Node(this);
//    undoStack->push(new AddNodeCommand(scene, node));
//    node->setPos(mapToScene(viewport()->rect().center()));
//    connect(node, &Node::positionChanged, this, &Editor::updateConnections);
//    qDebug() << "Node created at position:" << node->pos();
//}
...
//        QList<QGraphicsItem *> selectedItems = scene->items(rubberBandRect, Qt::IntersectsItemShape);
//
...
//    // Create a new connection and add it to the collection
//    Connection *connection = new Connection(start, end, scene);
//    undoStack->push(new AddConnectionCommand(scene, connection));
//    connections.push_back(connection);
//    qDebug() << "Finalized connection from" << start->toString() << "to" << end->toString();
//    // Remove the temporary connection line
//    scene->removeItem(currentConnection);
...
//#include <QUndoStack>
//
//Editor::Editor(QWidget *parent) : QGraphicsView(parent), scene(new QGraphicsScene(this)), scaleFactor(1.0), isPanning(false), isRubberBandSelecting(false), viewCenter(0, 0), currentConnection(nullptr), startPoint(nullptr), hoveredPoint(nullptr), rubberBand(nullptr), undoStack(new QUndoStack(this)) {
//    // Create the scene and set it
//    setScene(scene);
//    setRenderHint(QPainter::Antialiasing);
//    setDragMode(QGraphicsView::NoDrag);
...
//            }
//        } else {
//            startRubberBandSelection(event->pos());
//        }
//        event->accept();
//    } else {
//        QGraphicsView::mousePressEvent(event);
...
//void Editor::mouseMoveEvent(QMouseEvent *event) {
//    if (isPanning) {
//        QPointF delta = mapToScene(event->pos()) - mapToScene(dragStartPos.toPoint());
//        for (QGraphicsItem *item : scene->selectedItems()) {
//            item->moveBy(delta.x(), delta.y());
//        }
//        dragStartPos = event->pos();
//        event->accept();
//    } else if (isRubberBandSelecting) {
//        updateRubberBandSelection(event->pos());
//        event->accept();
//    } else if (currentConnection) {
//        QPointF scenePos = mapToScene(event->pos());
//        updateConnection(scenePos);
...
//}
//
//void Editor::startRubberBandSelection(const QPoint &pos) {
//    rubberBandStartPos = pos;
//    rubberBand->setGeometry(QRect(rubberBandStartPos, QSize()));
//    rubberBand->show();
//    isRubberBandSelecting = true;
//}
//
//void Editor::updateRubberBandSelection(const QPoint &pos) {
//    rubberBand->setGeometry(QRect(rubberBandStartPos, pos).normalized());
//}
//
//void Editor::finishRubberBandSelection() {
//    rubberBand->hide();
//    QRectF rubberBandRect = mapToScene(rubberBand->geometry()).boundingRect();
//    QList<QGraphicsItem*> itemsInRubberBand = scene->items(rubberBandRect, Qt::IntersectsItemShape);
//
//    scene->clearSelection();
//    for (QGraphicsItem *item : itemsInRubberBand) {
